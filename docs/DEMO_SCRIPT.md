...
**Scene 7 — Polygon anchor (public immutability).** Show the **anchors** view / Polygonscan: merkle roots anchored on Polygon **mainnet**. Open the first verified tx: `https://polygonscan.com/tx/0x6ce8629c4a3f2da6e40ef7485e312e0df7ec7ee3deeef2529903204fb23d664e`. *Say: "Batches of events are anchored on a public blockchain — anyone can independently confirm a record existed at a block time, for ~$0.0006 per batch. 18+ real anchors are already on mainnet."*
